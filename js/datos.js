...
const BD = {
  usuarios: [
    ...
    { id: 2, nombre: "Marco Jiménez", correo: "mjimenez@ucenfotec.ac.cr", rol: "docente", estado: "activo" },
...
//Devuelve el arreglo de un catalogo por su nombre 
function tabla(nombre) {
  return BD[nombre];
}

//Reemplaza el arreglo de un catalogo por uno nuevo
function guardarTabla(nombre, datos) {
  BD[nombre] = datos;
}

//Calcula el siguiente id buscando el id mas grande y sumandole 1
...
function nombrePorId(nombre, id) {
  const lista = tabla(nombre);
...
//Recarga la pagina para volver a los datos originales
